...
scale_fill = scale_fill_colorblind7(breaks = c("holdout_02", "repeatedholdout_02_2", "repeatedholdout_02_3", "repeatedholdout_02_4", "repeatedholdout_02_5"), labels = c("1-fold", "2-fold", "3-fold", "4-fold", "5-fold"))
scale_color = scale_colour_colorblind7(breaks = c("holdout_02", "repeatedholdout_02_2", "repeatedholdout_02_3", "repeatedholdout_02_4", "repeatedholdout_02_5"), labels = c("1-fold", "2-fold", "3-fold", "4-fold", "5-fold"))
...
dat_repeatedholdout = dat_repeatedholdout[method %in% c(
  "cv_5_2_False_post_naive_simulate_repeatedholdout_2", "cv_5_2_True_post_naive_simulate_repeatedholdout_2",
  "cv_5_3_False_post_naive_simulate_repeatedholdout_3", "cv_5_3_True_post_naive_simulate_repeatedholdout_3",
  "cv_5_4_False_post_naive_simulate_repeatedholdout_4", "cv_5_4_True_post_naive_simulate_repeatedholdout_4",
...
dat_repeatedholdout[method == "cv_5_2_False_post_naive_simulate_repeatedholdout_2", resampling := "repeatedholdout_02_2_False"]
dat_repeatedholdout[method == "cv_5_2_False_post_naive_simulate_repeatedholdout_2", method := "repeatedholdout_02_2_False_post_naive"]
dat_repeatedholdout[method == "cv_5_2_True_post_naive_simulate_repeatedholdout_2", resampling := "repeatedholdout_02_2_True"]
dat_repeatedholdout[method == "cv_5_2_True_post_naive_simulate_repeatedholdout_2", method := "repeatedholdout_02_2_True_post_naive"]

dat_repeatedholdout[method == "cv_5_3_False_post_naive_simulate_repeatedholdout_3", resampling := "repeatedholdout_02_3_False"]
dat_repeatedholdout[method == "cv_5_3_False_post_naive_simulate_repeatedholdout_3", method := "repeatedholdout_02_3_False_post_naive"]
dat_repeatedholdout[method == "cv_5_3_True_post_naive_simulate_repeatedholdout_3", resampling := "repeatedholdout_02_3_True"]
dat_repeatedholdout[method == "cv_5_3_True_post_naive_simulate_repeatedholdout_3", method := "repeatedholdout_02_3_True_post_naive"]

dat_repeatedholdout[method == "cv_5_4_False_post_naive_simulate_repeatedholdout_4", resampling := "repeatedholdout_02_4_False"]
dat_repeatedholdout[method == "cv_5_4_False_post_naive_simulate_repeatedholdout_4", method := "repeatedholdout_02_4_False_post_naive"]
dat_repeatedholdout[method == "cv_5_4_True_post_naive_simulate_repeatedholdout_4", resampling := "repeatedholdout_02_4_True"]
dat_repeatedholdout[method == "cv_5_4_True_post_naive_simulate_repeatedholdout_4", method := "repeatedholdout_02_4_True_post_naive"]
...
dat = rbind(dat_holdout, dat_repeatedholdout, fill = TRUE)
rm(dat_holdout, dat_repeatedholdout)
...
dat[, baseline := FALSE]
dat[method == "repeatedholdout_02_5_False_post_naive", baseline := TRUE]
...
dir.create(file.path("plots/", "repeatedholdout_ablation"), showWarnings = FALSE)
...
ggplot(data = agg) +
  ...
  labs(color = "Holdout", fill = "Holdout", linetype = "Reshuffling") +
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/valid.pdf", width = 9, height = 6)
...
ggplot(data = agg) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/normalized_valid.pdf", width = 9, height = 6)
...
ggplot(data = agg) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/test.pdf", width = 9, height = 6)
...
ggplot(data = agg) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/normalized_test.pdf", width = 9, height = 6)
...
ggplot(data = agg[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_valid.pdf", width = 9, height = 3)
...
ggplot(data = agg[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_normalized_valid.pdf", width = 9, height = 3)
...
ggplot(data = agg[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_test.pdf", width = 9, height = 3)
...
ggplot(data = agg[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_normalized_test.pdf", width = 9, height = 3)
...
for (classifierx in c("catboost", "xgboost", "funnel_mlp", "logreg")) {
  ...
  ggplot(data = agg[classifier == classifierx]) +
    ...
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_valid.pdf"), width = 9, height = 6)
  ...
  ggplot(data = agg[classifier == classifierx]) +
    ...
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_normalized_valid.pdf"), width = 9, height = 6)
  ...
  ggplot(data = agg[classifier == classifierx]) +
    ...
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_test.pdf"), width = 9, height = 6)
  ...
  ggplot(data = agg[classifier == classifierx]) +
    ...
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_normalized_test.pdf"), width = 9, height = 6)
}
...
for (classifierx in c("catboost", "xgboost", "funnel_mlp", "logreg")) {
  for (metricx in c("accuracy", "auc", "logloss")) {
    ...
    dir.create(file.path("plots/repeatedholdout_ablation/", subpath), showWarnings = FALSE)
    ...
    ggplot(data = agg[classifier == classifierx & metric == metricxid]) +
      ...
      theme_minimal() +
      theme(legend.position = "bottom")
    ggsave(gsub("subpath", subpath, "plots/repeatedholdout_ablation/subpath/valid.pdf"), width = 9, height = 15)
    ...
    ggplot(data = agg[classifier == classifierx & metric == metricxid]) +
      ...
      theme_minimal() +
      theme(legend.position = "bottom")
    ggsave(gsub("subpath", subpath, "plots/repeatedholdout_ablation/subpath/test.pdf"), width = 9, height = 15)
  }
}
...
ggplot(data = agg) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/imp.pdf", width = 9, height = 6)
...
ggplot(data = agg) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/rel.pdf", width = 9, height = 6)
...
ggplot(data = agg[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_imp.pdf", width = 9, height = 3)
...
ggplot(data = agg[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_rel.pdf", width = 9, height = 3)
...
for (classifierx in c("catboost", "xgboost", "funnel_mlp", "logreg")) {
  ...
  ggplot(data = agg[classifier == classifierx]) +
    ...
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_imp.pdf"), width = 9, height = 6)
  ...
  ggplot(data = agg[classifier == classifierx]) +
    ...
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_rel.pdf"), width = 9, height = 6)
}
...
ggplot(data = ranks) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/rel_ranks.pdf", width = 9, height = 6)
...
ggplot(data = ranks[metric == "ROC AUC"]) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom")
ggsave("plots/repeatedholdout_ablation/auc_rel_ranks.pdf", width = 9, height = 3)
...
for (classifierx in c("catboost", "xgboost", "funnel_mlp", "logreg")) {
  ...
  ggplot(data = ranks[classifier == classifierx]) +
    ...
    xlab("No. HPC Evaluations") +
    ylab("Mean Rank (Test Performance)") +
    labs(title = classifierxid) +
    labs(color = "Holdout", fill = "Holdout", linetype = "Reshuffling") +
    theme_minimal() +
    theme(legend.position = "bottom")
  ggsave(gsub("classifierx", classifierx, "plots/repeatedholdout_ablation/classifierx_rel_ranks.pdf"), width = 9, height = 6)
}
